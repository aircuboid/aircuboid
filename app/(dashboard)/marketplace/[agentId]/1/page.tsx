// File 1: app/(dashboard)/marketplace/[agentId]/1/page.tsx
'use client';
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gradient-to-b from-gray-800 to-gray-900 text-white">
      ...
      <div className="p-8 bg-gradient-to-b from-gray-700 to-gray-800 rounded-md shadow-md">
        ...
        <p className="text-lg text-gray-400 mb-6">Helps with creating marketing campaigns and improving customer engagement through AI-based suggestions.</p>
